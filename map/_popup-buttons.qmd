  ...
  window.addEventListener("load", () => {
    ...
    if (edshare === null) {
      ...
      edshareBtn.addEventListener("click", () => {
        ...
        // figure out if we have a city to add to the link
        cityChoice = pageURL.searchParams.get("city");
  
        cityChoiceParam = (cityChoice !== null) ? "&city=" + cityChoice : ""
        

        // copy the embed code to the clipboard
        navigator.clipboard.writeText(
          `{{< meta 360embed.before >}}{{< meta 360embed.url >}}` +
          cityChoiceParam +
          `{{< meta 360embed.after >}}`);
